...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
      ...
      r2 = new JRadioButton("First Deposit Account");
      ...
      JLabel number = new JLabel("xxxx-xxxx-xxxx-4362");
      ...
      if(ae.getSource() == submit){
        ...
        try{
          if(accountType.equals("")){
            ...
            Conn conn = new Conn();
            String query = "insert into signup2 values('"+ formno +"','"+ accountType +"','"+ cardnumber +"','"+ pinnumber+"','"+ facility+"')";
