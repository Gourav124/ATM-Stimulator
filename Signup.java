...
public class Signup extends JFrame implements ActionListener{
    long random;
    JTextField namTextField,fnamTextField,dobTextField,emTextField,addTextField,cityTextField,staTextField,pinTextField;
    JButton next;
    ...
    Signup(){
       ...
       maritalgroup.add(other);
        ...
        staTextField.setBounds(300,490,400,30);
        add(staTextField);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String fnam = fnamTextField.getText();
        ...
        try{
            if(name.equals("")){
                ...
                Conn c = new Conn();
                String query = "insert into signup values('"+formno+"','"+name+"','"+fnam+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
